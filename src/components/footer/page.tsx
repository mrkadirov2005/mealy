      ...
      <footer className={Styled.footer}>
        ...
        <section className={Styled.Section}>
          ...
          <div className={Styled.Users}>
            ...
            <a href='Biz bilan boglanish' className={Styled.a}>Biz Bilan Bog'lanish</a>
            <a href='Savol Javob' className={Styled.a}>Savol-Javob</a>
          </div>
          ...
          <div className={Styled.Bussines}>
            ...
            <a href='Mealyda Soting' className={Styled.a}>Uzumda Soting</a>
            <a href='Sotuvchi Kabinetiga kirish' className={Styled.a}>Sotuvchi Kabinetiga kirish</a>
          </div>
